...
public class PacketOutLoginPlayer extends Packet {
    ...
    public PacketOutLoginPlayer(final CloudPlayer cloudPlayer) {
        super(PacketRC.PLAYER_HANDLE + 1, new Document("player", cloudPlayer));
    }

    public PacketOutLoginPlayer(final UUID uniqueId, final CloudPlayer cloudPlayer, final String reason) {
