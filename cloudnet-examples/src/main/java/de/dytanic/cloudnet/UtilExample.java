...
public class UtilExample {
    ...
    public void toDo() {
        ...
        /*===========================*/
        final ProxyGroup proxyGroup = CloudAPI.getInstance().getProxyGroupData("Bungee"); //Returns a proxygroup
        proxyGroup.getWrapper().add("Second-Wrapper");
        CloudAPI.getInstance().updateProxyGroup(proxyGroup); //update a proxy group

        final ServerGroup serverGroup = CloudAPI.getInstance()
        ...
        final SimpleServerGroup simpleServerGroup = CloudAPI.getInstance().getServerGroupData("Lobby"); //Returns a cached server group
