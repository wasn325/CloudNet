...
public class ModuleInternalLoader implements ModuleLoader {
     ...
     */
    public ModuleInternalLoader(final ModuleConfig moduleConfig) {
        this.moduleConfig = moduleConfig;
    }

    @Override
    public Module loadModule() throws Exception {
        final Module module = (Module) getClass().getClassLoader().loadClass(this.moduleConfig.getMain()).getConstructor().newInstance();
